    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productCost', models.PositiveIntegerField()),
                ('providerFee', models.PositiveIntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=40)),
                ('mobile', models.CharField(max_length=20, null=True)),
                ('department', models.CharField(choices=[('Carpenters', 'Carpenters'), ('Mechanics', 'Mechanics'), ('Exterminators', 'Exterminators'), ('Technicians', 'Technicians'), ('Electricians', 'Electricians'), ('Plumbers', 'Plumbers')], default='Cardiologist', max_length=50)),
                ('status', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
